...
export type Status = "healthy" | "warning" | "degraded" | "critical" | "building_baseline" | "insufficient_data" | "info";
...
export const STATUS_CONFIG: Record<Status, StatusConfig> = {
  ...
  building_baseline: { label: "Building Baseline", icon: Clock, dot: "bg-info-500", text: "text-info-400", bg: "bg-info-500/10", border: "border-info-500/20" },
